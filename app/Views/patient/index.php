      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="dash-header">
            ...
            <div class="dash-subtitle">Manage and view all registered patients</div>
          </div>
        </div>
  ...
  <section class="content">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card dash-card">
            ...
            <div class="card-body">
              <!--class table changes, 
              New = table table-hover table-sm dash-table
              Old = table table-bordered table-striped table-sm -->
    ...
    <div class="modal fade" id="viewModal" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><i class="fas fa-eye"></i> Patient Details</h5>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
